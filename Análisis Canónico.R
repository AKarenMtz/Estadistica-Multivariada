...
#_________ Analisis Can髇ico _______________
...
# Interpretaci贸n: se observa una correlacion entre
# la variable can贸nica X1 y la variable latente Especie
...
ac_df %>% 
  ...
  geom_point()+
  ggtitle("Variable Can贸nica X2 contra Y2")

#Interpretaci髇: No de identifica correlacion
